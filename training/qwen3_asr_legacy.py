...
augmentor = auds.Compose([
    ...
    auds.OneOf([
        auds.Gain(p=1.0),
        auds.GainTransition(p=1.0, duration_unit='fraction', min_duration=0.2, max_duration=0.9),
    ], p=0.8),

    auds.TimeStretch(min_rate=0.8, max_rate=2.0, leave_length_unchanged=False, p=0.9),
    InsertPause(
    ...
    auds.ApplyImpulseResponse(ir_path='./Impulses', leave_length_unchanged=False, p=0.5),
...
def main():
    ...
    #     "json",
    #     data_files={
    #         "train": '/home/ali/ali/qwen_asr/ds_merged_jsonl/train.jsonl',
